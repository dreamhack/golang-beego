...
CREATE TABLE `FileInfo` (
  ...
  `Longtime` int(10) unsigned NOT NULL COMMENT '文件时常',
  `IsTranscode` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否经过转码处理',
...
INSERT INTO `FileInfo` VALUES (1,123,4294967295,'12320150108235152000',11299151,0,0,0,'.mp4'),(2,123,4294967295,'12320150109003326000',11299151,0,0,0,'.mp4');
